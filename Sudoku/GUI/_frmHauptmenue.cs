...
namespace Sudoku
{
    public partial class _frmHauptmenue : Form
    {
        ...
        private void ToolTipInitialisieren()
        {
            ...
            _tooltip.SetToolTip(_picGiraffe, "Das ist Lenoie. Sie gibt dir ein paar Tipps für das Spiel.");
        }
        ...
        #region Klick auf Giraffe
        private void pictureBox1_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.X > 102 && e.X < 142 && e.Y > 237 && e.Y < 285)
                MessageBox.Show("Test");
        }
        #endregion Klick auf Giraffe
        ...
        public void SpielErstellen(string daten, string loesung, Guid id)
        {
            _sudokus.Tables[0].Rows.Add(id, daten, loesung);
            ID = id;
            Speichern();
        }
